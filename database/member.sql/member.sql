...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 08, 2016 at 08:47 AM
...
--
-- Truncate table before insert `event_calendar`
--
...
(5, '2016-01-08', 'Test', 'sdsd', '2016-01-07 09:54:53');
...
--
-- Truncate table before insert `portal_department`
--

TRUNCATE TABLE `portal_department`;
--
...
--
-- Truncate table before insert `portal_dep_emails`
--

TRUNCATE TABLE `portal_dep_emails`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `portal_dl_forms`
--

TRUNCATE TABLE `portal_dl_forms`;
--
...
--
-- Truncate table before insert `portal_fav_provider`
--

TRUNCATE TABLE `portal_fav_provider`;
--
-- Dumping data for table `portal_fav_provider`
--

INSERT INTO `portal_fav_provider` (`fav_id`, `user_id`, `prov_name`, `prov_coordinator`, `prov_address`, `prov_contact`, `prov_code`, `prov_lat`, `prov_long`, `prov_region`, `date_pin`) VALUES
(2, 'A033IZ0', 'GP GENESIS DIALYSIS AND MULTISPECIALTY DIAGNOSTIC CENTER', ' ', '118 MALAKAS STREET BARANGAY CENTRAL CENTRAL QUEZON CITY', '6324411409 ', '1113', '14.603186', '121.049595', 'CENTRAL', '2016-01-07 18:41:51'),
(3, '5443460', 'PHILCARE EDSA CLINIC', ' ', '  EAST EDSA MANDALUYONG CITY', '', '1031', '14.584082', '121.057148', 'EAST EDSA', '2016-01-07 18:42:22');
...
--
-- Truncate table before insert `portal_feedbacks`
--

TRUNCATE TABLE `portal_feedbacks`;
--
...
--
-- Truncate table before insert `portal_informations`
--

TRUNCATE TABLE `portal_informations`;
--
...
DROP TABLE IF EXISTS `portal_logo`;
...
--
-- Truncate table before insert `portal_logo`
--

TRUNCATE TABLE `portal_logo`;
--
...
(1, 'PC10889', 'PHILHEALTHCARE INC', 'upload/logo/2fb627fad148c50ffe95ca0fe9d0e33b.png', 1, '2016-01-05 01:41:21');
...
--
-- Truncate table before insert `portal_messages`
--

TRUNCATE TABLE `portal_messages`;
--
...
--
-- Truncate table before insert `portal_messages_receiver`
--

TRUNCATE TABLE `portal_messages_receiver`;
--
...
--
-- Truncate table before insert `portal_news`
--

TRUNCATE TABLE `portal_news`;
--
-- Dumping data for table `portal_news`
--

INSERT INTO `portal_news` (`news_id`, `title`, `description`, `is_video`, `status`, `created`) VALUES
(1, 'Test1', '<p>This is another testing</p>\r\n', 0, 1, '2015-12-23 08:09:19'),
(2, 'Test 2', '<p><span style="color:#A52A2A"><strong><span style="font-family:arial,helvetica,sans; font-size:11px">Lorem ipsum dolor sit amet, consectetur adipiscing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</span></strong></span></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><span style="color:#FF8C00"><span style="font-family:arial,helvetica,sans; font-size:11px">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem. Ut enim ad minima veniam, quis nostrum exercitationem ullam corporis suscipit laboriosam, nisi ut aliquid ex ea commodi consequatur? Quis autem vel eum iure reprehenderit qui in ea voluptate velit esse quam nihil molestiae consequatur, vel illum qui dolorem eum fugiat quo voluptas nulla pariatur?</span></span></p>\r\n', 0, 1, '2015-12-23 08:22:23'),
(4, 'www.youtube.com/embed/ePbKGoIGAXY', '', 1, 1, '2015-12-28 06:53:48'),
(5, 'Test3', '<p>This is test23</p>\r\n', 0, 0, '2015-12-28 07:20:27'),
(11, 'Test555', '<p><span style="font-size:16px"><span style="color:rgb(0, 0, 0); font-family:arial,helvetica,sans">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci v</span></span></p>\r\n', 0, 0, '2015-12-30 10:46:20'),
(12, 'Another test upload', '<p><img alt="" src="/upload/profile/image/test.jpg" /><img alt="" src="/upload/profile/image/screenshot_crop.png" /></p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p><span style="color:rgb(0, 0, 0); font-family:arial,helvetica,sans; font-size:11px">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci v</span></p>\r\n', 0, 0, '2015-12-30 11:01:32'),
(13, '777test', '<p><img alt="" src="/xampp/htdocs/memberportal/upload/profile/image/screenshot_crop.png" /><span style="color:rgb(0, 0, 0); font-family:arial,helvetica,sans; font-size:11px">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci v</span></p>\n', 0, 0, '2015-12-30 11:07:19'),
(14, 'New Test', '<p><img alt="" src="/upload/profile/image/Lighthouse.jpg" /><span style="color:rgb(0, 0, 0); font-family:arial,helvetica,sans; font-size:11px">Sed ut perspiciatis unde omnis iste natus error sit voluptatem accusantium doloremque laudantium, totam rem aperiam, eaque ipsa quae ab illo inventore veritatis et quasi architecto beatae vitae dicta sunt explicabo. Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia dolor sit amet, consectetur, adipisci v</span></p>\r\n', 0, 1, '2015-12-30 11:08:29'),
(15, 'Image new', '<p>asdasdasd<img alt="" src="http://localhost/memberportal/upload/profile/image/Tulips.jpg" style="height:768px; width:1024px" /></p>\r\n', 0, 1, '2015-12-30 11:34:25');
...
--
-- Truncate table before insert `portal_pages`
--

TRUNCATE TABLE `portal_pages`;
--
...
(46, 'Online Schedule Appointment', 0, 0, 'ecu', 1, NULL),
(47, 'Reimbursement', 0, 0, '#', 1, NULL),
(48, 'Services', 0, 0, '#', 1, NULL),
...
(53, 'Member Feedback', 0, 0, '#', 0, NULL),
(54, 'FAQ', 0, 0, 'faq', 1, NULL),
(55, 'Logo', 1, 1, 'NULL', 1, NULL),
(56, 'Add Logo', 0, 55, 'logo/add', 1, NULL),
(57, 'List Logo', 0, 55, 'logo', 1, NULL),
(58, 'Users', 1, 1, 'users', 1, NULL),
(59, 'Add User', 0, 58, 'user/add', 1, NULL),
(60, 'List User', 0, 58, 'user', 1, NULL),
(61, 'ECU', 1, 1, 'ecu', 1, NULL),
(62, 'ECU Request', 0, 61, 'ecu/add', 1, NULL),
(63, 'ECU List', 0, 61, 'ecu', 1, NULL),
(64, 'LOA History', 0, 1, 'loa', 0, NULL),
(65, 'Member Feedback', 0, 1, 'feedback', 1, NULL),
(66, 'View Feedback', 0, 65, 'feedback/view_feedback', 1, NULL),
(67, 'Submit Feedback', 0, 65, 'feedback', 1, NULL);
...
CREATE TABLE `portal_users` (
  ...
  `agreement_no` varchar(128) COLLATE utf8_bin NOT NULL,
...
--
-- Truncate table before insert `portal_users`
--
...
INSERT INTO `portal_users` (`user_id`, `certNo`, `email`, `username`, `password`, `agreement_no`, `fname`, `lname`, `user_level`, `bdate`, `is_activated`, `date_created`, `dateVerified`, `image`, `login_attempt`, `login_attempt_date`, `login_date`, `logout_date`, `prepaid_access`) VALUES
...
(9, NULL, NULL, 'teletech', 'MTIzNDU21baaf03b9b4e7bff9869edad33dc803d', 'PC10889', NULL, NULL, 1, NULL, 1, NULL, NULL, 'dummy_m.jpg', 0, NULL, NULL, NULL, NULL);
...
--
-- Truncate table before insert `portal_users_details`
--

TRUNCATE TABLE `portal_users_details`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `portal_users_other_info`
--

TRUNCATE TABLE `portal_users_other_info`;
-- --------------------------------------------------------
...
DROP TABLE IF EXISTS `portal_videos`;
...
--
-- Truncate table before insert `portal_videos`
--

TRUNCATE TABLE `portal_videos`;
-- --------------------------------------------------------
...
--
-- Truncate table before insert `prepaid_access`
--

TRUNCATE TABLE `prepaid_access`;
--

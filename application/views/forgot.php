                  ...
                  <!-- reg form-->      
                    <div class="panel panel-philcare">
                        <div class="panel-heading">
                            ...
                            <div class="pull-right main-title">Forgot Password</div>
                        </div>
                        <div class="panel-forgot-body">
                            <div class="container">

                                <p class="lead">Please provide the email address you've used to register this account and we'll send to you your username and password.</p>

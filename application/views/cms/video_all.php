                    ...
                    <div class="table-responsive">
                        <table class="table">
                            ...
                            <tr>
                                ...
                                <td><?php echo $video->agreement_no ?></td>
                                <td>
                                    <?php
                                    if($video->status==1){
                                        echo 'Active';
                                ...
                                <td>
                                    ...
                                    ?>
                                    <a class="btn btn-success" href="<?php echo base_url("news/video_edit_admin/".$video->video_id); ?>">Edit</a>
                                    <a class="btn btn-default-orange" href="<?php echo base_url("news/video_delete/".$video->video_id); ?>">Delete</a>
                                </td>
                            </tr>
                            <?php
                            }

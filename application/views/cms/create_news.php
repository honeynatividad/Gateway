<div class="col-md-9">
	...
	<script src="<?php echo base_url("resources");?>/js/bootstrap-datepicker.js"></script>
        <div class="panel panel-philcare">
            ...
            <!-- start messages -->
                    <table class="table" id="tablemsg">
                        <thead id="msgheader">
                            <tr>
                                <th>
                                    <i class="glyphicon glyphicon-edit"></i> CREATE Newsfeed
                                </th>
                                <th></th>
                                <th></th>
                                <th></th>
                                ...
                                CKEDITOR.replace( 'editor1',
                {
                    ...
                    filebrowserUploadUrl  :'http://www.philcare.com.ph/gateway/resources/ck/editor/filemanager/connectors/php/upload.php?Type=File',
		    filebrowserImageUploadUrl : 'http://www.philcare.com.ph/gateway/resources/ck/editor/filemanager/connectors/php/upload.php?Type=Image',
		    filebrowserFlashUploadUrl : 'http://www.philcare.com.ph/gateway/resources/ck/editor/filemanager/connectors/php/upload.php?Type=Flash'
                    
                    
                    //filebrowserUploadUrl  :'http://localhost/membeportal/resources/ck/editor/filemanager/connectors/php/upload.php?Type=File',
		    ...
		    //filebrowserFlashUploadUrl : 'http://loaclhost/memberportal/resources/ck/editor/filemanager/connectors/php/upload.php?Type=Flash'

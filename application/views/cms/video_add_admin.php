            ...
            <!-- start messages -->
                    <table class="table" id="tablemsg">
                        <thead id="msgheader">
                            <tr>
                                <th>
                                    <i class="glyphicon glyphicon-edit"></i> Upload video
                                </th>
                                <th></th>
                                <th></th>
                                <th></th>
                    ...
                    <form method="POST" action="" class="form-horizontal" enctype="multipart/form-data">
                        <div class="col-sm-10 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="file" name="fileToUpload" value="" class="form-control fcntrl" >
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <div class="checkbox">
                                        <label><input type="checkbox" value="1" name="upload_all">Upload to all microsite</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-group">

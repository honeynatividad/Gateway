            ...
            <!-- start messages -->
                    <table class="table" id="tablemsg">
                        <thead id="msgheader">
                            <tr>
                                <th>
                                    <i class="glyphicon glyphicon-edit"></i> Edit video link
                                </th>
                                <th></th>
                                <th></th>
                                <th></th>
                    ...
                    <form method="POST" action="" class="form-horizontal" enctype="multipart/form-data">
                        <div class="col-sm-10 col-md-12">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" name="title" value="<?php echo $video->title ?>" class="form-control fcntrl" required="required">
                                </div>
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-control col-sm-10" id="sel1" name="agreement_no">
                                        <option value="<?php echo $video->agreement_no ?>"><?php echo $video->agreement_no ?></option>

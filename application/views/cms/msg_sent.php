<div class="col-md-9">
    ...
    <div class="panel panel-philcare">
        ...
        <div class="panel-body">
            ...
            <tr class="coloring" id="margmsg-<?php echo $msg->msg_id;?>">
              <td>
              <input type="checkbox" name="msg_id[]" class="checkitem" value="<?php echo $msg->msg_id;?>">
              </td>
              <td><?php echo date('F d',strtotime($msg->date_created));?></td>
              <td>Philcare Inc</td>
              <td>
              <a href="<?php echo base_url('/messages/msg/'.$msg->msg_id);?>"><?php echo $msg->subject;?></a>
              </td>
              <td></td>
            </tr>

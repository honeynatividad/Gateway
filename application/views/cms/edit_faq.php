            ...
            <!-- start messages -->
                    <table class="table" id="tablemsg">
                        <thead id="msgheader">
                            <tr>
                                <th>
                                    <i class="glyphicon glyphicon-edit"></i> EDIT FAQ
                                </th>
                                <th></th>
                                <th></th>
                                <th></th>
                    ...
                    <form method="POST" action="" class="form-horizontal">
                        ...
                        <?php foreach($result as $r): ?>
                            <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                    <textarea cols="50" id="editor1" name="description" rows="20"><?php echo $r->content ?></textarea>      
                                         <script>
                                ...
                                CKEDITOR.replace( 'editor1',
                {
                    ...
                    filebrowserUploadUrl  :'http://philcare.com.ph/gateway/resources/ck/editor/filemanager/connectors/php/upload.php?Type=File',
		    filebrowserImageUploadUrl : 'http://philcare.com.ph/gateway/resources/ck/editor/filemanager/connectors/php/upload.php?Type=Image',
		    filebrowserFlashUploadUrl : 'http://philcare.com.ph/gateway/resources/ck/editor/filemanager/connectors/php/upload.php?Type=Flash'

...
<p><?php printf( __( 'Your order has been received. Please follow instructions sent by Dragonpay to your email. Once paid and verified by Dragonpay, you will receive a confirmation email from PhilCare of your payment. Your order details are shown below for your reference:', 'woocommerce' ), $order->get_formatted_billing_full_name() ); ?></p>

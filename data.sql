...
insert  into `event_calendar`(`id`,`event_date`,`title`,`description`,`date_created`) values (4,'2015-01-31','Philcare Vaccine Holiday','test test test','2015-01-12 00:53:52');
...
/*Data for the table `portal_dep_emails` */
...
insert  into `portal_department`(`dep_id`,`dep_name`) values (1,'Mktg'),(2,'CSAD'),(3,'Call Center'),(4,'BRO based on company'),(5,'Customercare');
...
/*Data for the table `portal_dl_forms` */

insert  into `portal_dl_forms`(`dl_id`,`dl_name`,`dl_url`,`sort`,`date_created`,`date_modified`,`modified_by`) values (1,'Individual Findings','https://mail-attachment.googleusercontent.com/attachment/u/0/?ui=2&ik=9eba2aa0ec&view=att&th=14a37808078b04fe&attid=0.1&disp=safe&zw&saduie=AG9B_P8Hu0Yxrpvwl4p0DteXvAbT&sadet=1418565019592&sads=nWiZAM4tOF1yK-if-_xjFBdH5QE',NULL,'2014-12-07 22:12:24',NULL,NULL),(2,'BR Website','https://doc-04-b8-docs.googleusercontent.com/docs/...',NULL,NULL,NULL,NULL);
...
/*Data for the table `portal_fav_provider` */
...
/*Data for the table `portal_feedbacks` */

insert  into `portal_feedbacks`(`fbs_id`,`user_id`,`subject`,`contact_no`,`comments`,`read_status`,`date_created`,`is_deleted`,`date_deleted`) values (4,2,'sdassdas asdasd  asdasd asd ','122232321','asldkalksdaskdlas',0,'2014-12-14 17:12:16',0,NULL),(5,2,'lsdma,','1232323','alsdlamlms',0,'2014-12-14 17:44:33',0,NULL),(6,2,'1','12312312','asdasdas asdas da sdas da sdas das das',0,'2015-01-26 02:15:03',0,NULL),(7,2,'Suggestions','1233333','1dsdas',0,'2015-01-26 02:16:19',0,NULL),(8,2,'Benefit Coverage & Availment','123123123','asda',0,'2015-03-13 08:30:36',0,NULL),(9,2,'Suggestions','asda','ASDAS',0,'2015-03-13 08:35:03',0,NULL),(10,2,'Reimbursement & Claims','ASDAS','ASDASDAS',0,'2015-03-13 08:35:17',0,NULL),(11,2,'Reimbursement & Claims','asdas','asdasds',0,'2015-03-13 08:36:16',0,NULL),(12,2,'Benefit Coverage & Availment','c','asda',0,'2015-03-13 08:36:37',0,NULL),(13,2,'Reimbursement & Claims','asdasdas','asdasdas',0,'2015-03-13 08:37:14',0,NULL),(14,2,'Complaints & Compliments','asdas','asdas',0,'2015-03-13 08:37:59',0,NULL),(15,2,'Complaints & Compliments','asdas','asdas',0,'2015-03-13 08:39:50',0,NULL),(16,2,'Benefit Coverage & Availment','ASDAS','asdasdas',0,'2015-03-13 08:40:41',0,NULL),(17,2,'Reimbursement & Claims','sdasd','asdas',0,'2015-03-13 08:42:40',0,NULL),(18,2,'Benefit Coverage & Availment','asdas','asdasdas',0,'2015-03-13 08:42:49',0,NULL),(19,2,'Complaints & Compliments','asda','asdas',0,'2015-03-13 08:43:10',0,NULL),(20,2,'Complaints & Compliments','asda','asdas',0,'2015-03-13 08:45:20',0,NULL),(21,2,'Complaints & Compliments','asda','asdas',0,'2015-03-13 08:45:52',0,NULL),(22,2,'Reimbursement & Claims','asdas','asdas',0,'2015-03-13 08:47:19',0,NULL),(23,2,'Suggestions','asdasdas','klkl',0,'2015-03-13 08:47:50',0,NULL),(24,2,'Suggestions','asdasdas','klkl',0,'2015-03-13 08:50:13',0,NULL),(25,2,'Suggestions','asdasdas','klkl',0,'2015-03-13 08:51:12',0,NULL),(26,2,'Complaints & Compliments','hjh','hjh',0,'2015-03-13 08:53:29',0,NULL),(27,2,'Complaints & Compliments','hjh','hjh',0,'2015-03-13 08:54:17',0,NULL),(28,2,'Complaints & Compliments','hjh','hjh',0,'2015-03-13 08:54:51',0,NULL);
...
/*Data for the table `portal_messages` */

insert  into `portal_messages`(`msg_id`,`sender`,`subject`,`messages`,`is_deleted`,`deleted_by`,`date_created`) values (1,NULL,'This is a test','<p><img alt=\"\" src=\"http://www.philcare.com.ph/wp-content/uploads/2014/11/01meningcoccal-disease3.jpg\" style=\"height:326px; width:500px\" /></p>\r\n\r\n<p><span style=\"color:rgb(116, 116, 116); font-family:arial,helvetica,sans-serif; font-size:12px\">We believe that total health means acheiving a complete harmony of mind and body. It&rsquo;s achieving a state where you can enjoy life to the fullest. If you think this is the kind of health care that you deserve, hook up with us. Together, let&rsquo;s make health happen.</span></p>\r\n',0,NULL,'2014-12-08 09:13:37'),(2,NULL,'test 2015','<p>asdjaskdjasjkd askdjaksjdas aksjdkajsda akdkajsda kasdkjas</p>\r\n',0,NULL,'2015-01-29 00:36:07');
...
/*Data for the table `portal_messages_receiver` */

insert  into `portal_messages_receiver`(`rcv_msg_id`,`msg_id`,`receiver_id`,`read_status`,`is_deleted`,`deleted_by`,`date_deleted`) values (2,1,2,1,0,NULL,NULL),(3,2,2,1,0,NULL,NULL),(4,2,13,1,0,NULL,NULL);
...
/*Data for the table `portal_pages` */

insert  into `portal_pages`(`page_id`,`page_name`,`page_parent`,`has_sub`,`page_url`,`active_stat`,`date_created`) values (1,'Newsfeed',0,0,'home',1,NULL),(2,'My Account',0,1,'account',1,NULL),(3,'Messages',0,0,'messages',1,NULL),(4,'My Health',0,1,'health',0,NULL),(5,'Providers',0,1,'providers',1,NULL),(6,'Calendar',0,1,'calendar',1,NULL),(7,'Wellness Buddies',0,0,'wellness',0,NULL),(8,'Rewards',0,0,'rewards',0,NULL),(9,'Customer Service',0,1,'cservice',1,NULL),(10,'FAQ',0,0,'faq',1,NULL),(11,'My Profile',0,2,'account',1,NULL),(12,'My Medical Information',0,2,'account/mmi',1,NULL),(13,'My Availment Record',0,2,'account/mar',1,NULL),(14,'My Benefits',0,2,'account/benefits',1,NULL),(15,'Health Risk Assessment',0,4,'health',1,NULL),(16,'BMI and Calorie Calculator',0,4,'health/bmi',1,NULL),(17,'Events',0,6,'calendar',0,NULL),(18,'Scheduled Appointment',0,6,'calendar/sched',1,NULL),(19,'Downloadable Forms',0,9,'cservice',1,NULL),(20,'Letter of Authorization Request',0,9,'cservice/lar',0,NULL),(21,'Temporary Membership Card',0,9,'cservice/card',0,NULL),(22,'Feedback',0,9,'cservice/feedback',1,NULL),(23,'Replacement of Cards',0,9,'cservice/replacement',0,NULL),(24,'Dashboard',1,0,'admin',1,NULL),(25,'Messages',1,1,NULL,1,NULL),(26,'Customer Service',1,1,NULL,1,NULL),(27,'Information',1,1,NULL,1,NULL),(28,'Inbox',0,25,NULL,0,NULL),(29,'Sent',0,25,'messages/sent',1,NULL),(30,'Create Message',0,25,'messages/create',1,NULL),(31,'Downloadable Forms',0,26,'admin/dlforms',1,NULL),(32,'FAQ',0,27,'admin/faq',1,NULL),(33,'Terms and Condition',0,27,'admin/terms',1,NULL),(34,'Privacy',0,27,'admin/privacy',1,NULL),(35,'My Provider',0,5,'providers',1,NULL),(36,'Find A Provider',0,5,'providers/findp',1,NULL),(37,'Feedbacks',0,26,'admin/fbslist',1,NULL),(38,'Others',1,1,NULL,1,NULL),(39,'Login Descripton Content',0,38,'admin/logdesc',1,NULL),(40,'Reg Description Content',0,38,'admin/regdesc',1,NULL),(41,'Calendar',1,1,NULL,1,NULL),(42,'Create Events',0,41,'calendar/admincreateevents',1,NULL),(43,'Event List',0,41,'calendar/adminceventslist',1,NULL),(44,'Add CS Recepient',0,26,'admin/addrecep',1,NULL),(45,'CS List',0,26,'admin/viewallrec',1,NULL);
...
/*Data for the table `portal_users` */

insert  into `portal_users`(`user_id`,`certNo`,`email`,`username`,`password`,`fname`,`lname`,`user_level`,`bdate`,`is_activated`,`date_created`,`dateVerified`,`image`,`login_attempt`,`login_attempt_date`,`login_date`,`logout_date`,`prepaid_access`) values (1,'0','philadmin@gmail.com','philadmin','MW0zUlk0eEI=1baaf03b9b4e7bff9869edad33dc803d','Admin','Phil',1,'1989-09-29',1,'2014-11-27 23:10:00',NULL,'1422289013.jpg',4,'2015-05-04 01:01:08',NULL,NULL,NULL);
...
/*Data for the table `portal_users_details` */
...
/*Data for the table `portal_users_other_info` */
...
/*Data for the table `prepaid_access` */

insert  into `prepaid_access`(`pa_id`,`prepaid_name`) values (1,'ER'),(2,'IN'),(3,'GROUP'),(4,'SMART CHECKUP');
